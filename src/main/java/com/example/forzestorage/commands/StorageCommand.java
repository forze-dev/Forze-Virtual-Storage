...
sender.sendMessage(ChatColor.GRAY + "Повний список: https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/Material.html");
            return;
        }
        ...
        try {
            ...
            if (amount > 64) {
                sender.sendMessage(ChatColor.YELLOW + "Увага: кількість більше 64. Предмет буде розділено на кілька стаків.");
            }
        ...
        try {
            ...
            sender.sendMessage(ChatColor.GREEN + "Додано " + amount + " " + material.name() + " до сховища гравця " + target.getName());
            ...
            plugin.getLogger().warning("Помилка при додаванні предмета " + material.name() + " гравцю " + target.getName() + ": " + e.getMessage());
            e.printStackTrace();
        }
    }
